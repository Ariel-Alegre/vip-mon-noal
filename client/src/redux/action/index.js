import axios from 'axios'
 ...
 export const register = (userData) => {
  return async (dispatch) => {
    try {
      const response = await axios.post('https://vip-mon-noal-production-d375.up.railway.app/register', userData);
...
export const login = (email, password) => {
  return async (dispatch) => {
    try {
      const response = await axios.post("https://vip-mon-noal-production-d375.up.railway.app/login", {
        email,
        password,
      });
  ...
  return async (dispatch) => {
    try {
      const res = await axios.get(
        "https://vip-mon-noal-production-d375.up.railway.app/datapersonal",
        {
          method: "GET",
          headers: {
            Authorization: `${token}`,
...
export const postProduct = (payload) => {
  return async (dispatch) => {
    try {
      const res = await axios.post('https://vip-mon-noal-production-d375.up.railway.app/post', payload);
      const data = res.data;
...
export const deleteProduct= (productId) => {
  return async (dispatch) => {
    try {
      const res = await axios.delete(`https://vip-mon-noal-production-d375.up.railway.app/delete/${productId}`);
      const data = res.data;
      dispatch({
        type: "DELETE_PRODUCT",
        payload: data
...
export const AllProducts = (payload) => {
  return async (dispatch) => {
    try {
      const res = await axios.get('https://vip-mon-noal-production-d375.up.railway.app/products', payload);
      const data = res.data;
...
export const AllUsers= (payload) => {
  return async (dispatch) => {
    try {
      const res = await axios.get('https://vip-mon-noal-production-d375.up.railway.app/users', payload);
      const data = res.data;
...
export const ProductDetail= (productId) => {
  return async (dispatch) => {
    try {
      const res = await axios.get(`https://vip-mon-noal-production-d375.up.railway.app/product/${productId}`);
      const data = res.data;
...
export const PaymentPaypal= (productId) => {
  return async (dispatch) => {
    try {
      const res = await axios.post(`https://vip-mon-noal-production-d375.up.railway.app/create-payment/${productId}`);
      const data = res.data;
...
export const Order= (payload) => {
  return async (dispatch) => {
    try {
      const res = await axios.post(`https://vip-mon-noal-production-d375.up.railway.app/order`, payload);
      const data = res.data;
      dispatch({
        type: "ORDER",
        payload: data
...
export const AllOrder= () => {
  return async (dispatch) => {
    try {
      const res = await axios.get(`https://vip-mon-noal-production-d375.up.railway.app/orders`);
      const data = res.data;
      dispatch({
        type: "ALL_ORDER",
        payload: data
...
export const OneOrder= (orderId) => {
  return async (dispatch) => {
    try {
      const res = await axios.get(`https://vip-mon-noal-production-d375.up.railway.app/order/${orderId}`);
      const data = res.data;
      dispatch({
        type: "DETAILS_ORDER",
        payload: data
...
export const deleteOrder= (orderId) => {
  return async (dispatch) => {
    try {
      const res = await axios.delete(`https://vip-mon-noal-production-d375.up.railway.app/order/delete/${orderId}`);
      const data = res.data;
      dispatch({
        type: "DELETE_ORDER",
        payload: data
...
export const updateProduct= (productId, payload) => {
  return async (dispatch) => {
    try {
      const res = await axios.put(`https://vip-mon-noal-production-d375.up.railway.app/productupdate/${productId}`, payload);
